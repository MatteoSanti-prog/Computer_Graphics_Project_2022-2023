...
void A16::createEnvironment(std::vector<VertexEnv> &vPos, std::vector<uint32_t> &vIdx) {
	//X Y Z
	vPos.push_back({{-15,15,0}, {0,0,-1}, {0,1,0}});
	...
	vPos.push_back({{8,-8, 0}, {0,1,0}, {0,0,1}});
	//vPos.push_back(8); vPos.push_back(-8); vPos.push_back(0); //E'	//19
	vPos.push_back({{6,-8, 0}, {0,1,0}, {0,0,1}});
	//vPos.push_back(6); vPos.push_back(-8); vPos.push_back(0); //H'
	vPos.push_back({{6,0,0}, {0,1,0}, {0,0,1}});
	//vPos.push_back(6); vPos.push_back(0); vPos.push_back(0); //G'
	vPos.push_back({{8,0,0}, {0,1,0}, {0,0,1}});
	//vPos.push_back(8); vPos.push_back(0); vPos.push_back(0); //'

	vPos.push_back({{6,1.8,0}, {0,1,0}, {0,0,1}});
	//vPos.push_back(6); vPos.push_back(1.8); vPos.push_back(0); //J'	//23
	vPos.push_back({{-5.4,1.8,0}, {0,1,0}, {0,0,1}});
	//vPos.push_back(-5.4); vPos.push_back(1.8); vPos.push_back(0); //R'
	vPos.push_back({{-5.4,-0.2,0}, {0,1,0}, {0,0,1}});
	//vPos.push_back(-5.4); vPos.push_back(-0.2); vPos.push_back(0); //Q' //AND G'

	vPos.push_back({{-5.4,-2.3,0}, {0,1,0}, {0,0,1}});
	//vPos.push_back(-5.4); vPos.push_back(-2.3); vPos.push_back(0); //N'	//26
	vPos.push_back({{-7.4,-2.3,0}, {0,1,0}, {0,0,1}});
	//vPos.push_back(-7.4); vPos.push_back(-2.3); vPos.push_back(0); //K'
	vPos.push_back({{-7.4,7.4,0}, {0,1,0}, {0,0,1}});
	//vPos.push_back(-7.4); vPos.push_back(7.4); vPos.push_back(0); //O'
	vPos.push_back({{-5.4,7.4,0}, {0,1,0}, {0,0,1}});
	//vPos.push_back(-5.4); vPos.push_back(7.4); vPos.push_back(0); //P'	//29
